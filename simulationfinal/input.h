...
typedef struct GATE_type
{
  ...
  int Type,Nfi,Nfo,Mark,Val,po; 
  char *Rpath,*Fpath;            //Type, No of fanins, No of fanouts, Marker,Value
...
****************************************************************************************************************************/
/****************************************************************************************************************************/
int ReadVec(FILE *,PATTERN *);  //read vector file
void backtrace(GATE *,int *,int *);
void P();
int simulateCircuit(GATE *, int , int *, int * , FILE* );
int charToInt(char);
char intToChar(int);
